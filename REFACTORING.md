# VectoryTones Refactoring

This document describes the refactored codebase structure for VectoryTones.
...
**After:**
```python
from vectorytones.models import initialize_models, get_clap_model
...
**After:**
```python
from vectorytones.models import embed_audio_file, embed_text_query
...
**After:**
```python
from vectorytones.models import train_and_score
from vectorytones.utils import clips, good_votes, bad_votes, get_inclusion
...
**After:**
```python
from vectorytones.utils import update_progress, get_progress
...
**After:**
```python
from vectorytones.utils import clips, good_votes, bad_votes
from vectorytones.utils import clear_all, set_inclusion, get_inclusion
